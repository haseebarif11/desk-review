...
SYSTEM_PROMPT = (
    ...
    "NEVER invent specific numbers, percentages, or counts that are not stated "
    "or clearly implied in the original resume. If a metric would strengthen "
    "the bullet but none is given, use a bracketed placeholder like [X%] or "
    "[X issues] instead of a fabricated number, so the candidate knows to fill "
    "in their own real figure.\n"
